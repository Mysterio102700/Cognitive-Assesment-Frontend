  ...
  return (
    <>
      <div className="popup-overlay " style={{ zIndex: 9999 }}>
        <div className="confirmation-card container shadow-lg m-5 p-5 mirror">
          <div className="seats row">
            {Assignments.map((assignment) => (
              <div key={`assignment-${assignment}`} className="col-md-4 mb-4">
                <button
          ...
          <div className="row">
            <div className="col align-item-center justify-content-center d-flex">
              <button
